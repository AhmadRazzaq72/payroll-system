...
import { FaDownload, FaEnvelope, FaPhone, FaGlobe, FaDollarSign, FaCalendarAlt, FaRegClock } from "react-icons/fa";
  ...
  return (
    <div className="bg-white w-full lg:w-1/5 rounded-2xl shadow-md p-6 text-sm text-gray-700 space-y-6">
      ...
      <div className="flex flex-col items-center text-center">
        <div className="w-24 h-24 rounded-full mb-4 shadow bg-blue-500 text-white flex items-center justify-center text-4xl font-bold uppercase">
        ...
        <>
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-3 text-sm">
              ...
              <p><span className="font-medium">Base Salary:</span> RS{employee.base_salary}</p>
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-3 text-sm">
              <p><span className="font-medium">Bonus:</span> RS{employee.bonus}</p>
              <p><span className="font-medium">HRA:</span> RS{employee.hra}</p>
            </div>
          </div>
